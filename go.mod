...
require (
	...
	github.com/skevetter/devpod v0.26.1
...
require (
	...
	github.com/skevetter/agentapi v1.0.0 // indirect
	github.com/skevetter/api v1.0.1 // indirect
	github.com/skevetter/apiserver v1.0.2 // indirect
